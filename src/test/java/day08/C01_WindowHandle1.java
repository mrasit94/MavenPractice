...
//      ILK SAYFANIN IDSINI ALALIM
        ...
        for(String eachHandle : allWindowHandles){
            //eger listedeki id window1 e esit degilse, otomatik olarak window2 ye esittir.
            if(!eachHandle.equals(window1Handle)){
                driver.switchTo().window(eachHandle);//burdaki eachHandle window2 handleina esittir
                break;
            }
        }
        ...
        //Acilan yeni pencerenin sayfa başlığının (title)
